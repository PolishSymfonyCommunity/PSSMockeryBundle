...
namespace PSS\Bundle\MockeryBundle\Tests\DependencyInjection;
...
{
    /**
     * @var \PSS\Bundle\MockeryBundle\DependencyInjection\MockerContainer $container
     */
    ...
    {
        $reflection = new \ReflectionClass('PSS\Bundle\MockeryBundle\DependencyInjection\MockerContainer');
